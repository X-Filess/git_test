...
#define PIC_BIG_PATH "/tmp/photo/picasa_big.jpg"
...
{
//	int image_type = 0;
    GxMsgProperty_PlayerPlay player_play = {0};
	...
	{
	    strcpy(player_play.url, PIC_BIG_PATH);
	...
	{
	    strcpy(player_play.url, WORK_PATH"theme/image/youtube/fail.jpg");
        app_send_msg_exec(GXMSG_PLAYER_PLAY, (void *)(&player_play));
